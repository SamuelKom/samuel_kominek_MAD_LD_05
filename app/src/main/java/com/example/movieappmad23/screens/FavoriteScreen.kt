...
@Composable
fun FavoriteScreen(navController: NavController, moviesViewModel: FavoriteScreenViewModel){

    val favoriteMoviesState by moviesViewModel.favoriteMoviesState.collectAsState()
